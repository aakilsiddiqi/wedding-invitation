        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 sm:gap-20 items-center justify-center max-w-4xl mx-auto">
          ...
          >
            <motion.div
              ...
              className="relative w-72 h-80 sm:w-80 sm:h-96 rounded-t-full border border-gold/30 bg-navy-light/40 flex items-center justify-center p-6 shadow-elevated backdrop-blur-sm overflow-hidden"
            >
              <div className="absolute inset-2 rounded-t-full border border-gold/10 pointer-events-none" />
              
              <svg className="w-full h-full text-gold fill-current" viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Bride illustration">
                <defs>
          ...
          >
            ...
            >
              ...
              <svg className="w-full h-full text-gold fill-current" viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Groom illustration">
                <defs>
