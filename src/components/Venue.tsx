    ...
    <section className="relative py-24 bg-navy text-cream overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Details & Illustration (5 cols on large screens) */}
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left">
            {/* Custom SVG Palace Illustration */}
            <motion.div
              animate={{ y: [0, -8, 0] }}
            ...
            >
              <a
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-full border border-gold/30 bg-gold-gradient text-navy font-playfair font-semibold text-xs tracking-wider uppercase hover:shadow-lg hover:shadow-gold/15 transition-all outline-none"
              >
          ...
          {/* Embedded Google Map (7 cols on large screens) */}
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 1.0, delay: 0.2 }}
            className="lg:col-span-7 w-full h-[320px] sm:h-[420px] rounded-3xl overflow-hidden border border-gold/30 shadow-2xl relative glow-effect"
          >
            {/* Gold corner accents */}
